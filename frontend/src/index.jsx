...
import Header from "./ind/header.jsx"; // ind 폴더 내 Header 컴포넌트 경로
import Footer from "./ind/footer.jsx"; // ind 폴더 내 Footer 컴포넌트 경로
        ...
        <div id="itemListArea" className="dFlex">
          <div id="item">
            <div className="itemImgArea">
              <img
                src={require("./images/whisky/Imperial17.jpg")}
                alt="itemImg"
              />
            </div>
          ...
          <div id="item">
            <div className="itemImgArea">
              <img
                src={require("./images/whisky/Imperial19.png")}
                alt="itemImg"
              />
            </div>
            <div className="itemTxtarea">
          ...
          <div id="item">
            <div className="itemImgArea">
              <img
                src={require("./images/whisky/Imperial21.jpg")}
                alt="itemImg"
              />
            </div>
            <div className="itemTxtarea">
